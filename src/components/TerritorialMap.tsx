...
export default function TerritorialMap() {
  const territories = [
    {
      id: "ghabaan",
      name: "Wilayat of Ghabaan (Ismailabad)",
      ...
      description:
        "Wilayat of Ghabaan (Ismailabad): 0.01 sq mi. The historical core and seat of the capital, Ismailabad. Characterized by dense, cultivated forest terrain, housing the Royal Diwan, treasury archives, and sovereign councils. Administered by Governor Al-Himalayi.",
    },
    {
      id: "jamaah",
    ...
    },
    {
      ...
      description:
        "Overseas Territory of Al Maqsoodi: 4.87 acres. Located internationally in Gadap Town, Karachi. A crown-administered enclave serving as the Sultanate's primary diplomatic, event-hosting, and hospitality hub for macro-national visitors. Authority: Umm Omar Syed.",
    },
  ];
    ...
    <div className="bg-white rounded-2xl border border-ivory-300 p-6 md:p-8 shadow-sm space-y-6">
      ...
      <div className="border-b border-ivory-200 pb-4">
        ...
        <h3 className="text-2xl font-serif font-bold text-ottoman-red-950 flex flex-wrap items-center gap-2">
          ...
          <span className="font-arabic text-lg text-brass-gold-700 font-normal notranslate" translate="no" dir="rtl">
          ...
          >
            ...
            <div className="p-5 bg-gradient-to-r from-ottoman-red-950 to-ottoman-red-900 text-ivory-100 space-y-1 relative">
              <div className="flex items-center justify-between">
                ...
                <span className="font-arabic text-xs text-brass-gold-300 notranslate" translate="no" dir="rtl">
                  {region.arabicName}
                </span>
              </div>
            ...
            <div className="p-5 space-y-4 flex-1 flex flex-col justify-between font-sans">
              <div className="space-y-3">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-[10px] font-mono text-stone-500 notranslate" translate="no">
                    {region.coordinates}
                  </span>
                </div>
